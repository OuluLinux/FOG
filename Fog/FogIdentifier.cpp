...
const FogMetaType& FogIdentifier::meta_type() const {
	return FogMetaType::identifier_type();
}

FogTokenType::TokenType FogIdentifier::pp_token_type_enum() const {
...
FogToken::NameSort FogIdentifier::sort_class() const {
	return NAME_NAME;
}

FogTokenType::TokenType FogIdentifier::token_type_enum() const {
	return FogTokenType::Identifier;
}
