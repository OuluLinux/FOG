...
//    FogSemantics(const FogSemantics& aSemantics);               // Default ok.
    bool operator!() const { return SuperName::operator!() && SuperMeta::operator!() && SuperAuto::operator!()
    ...
    bool is_declaration() const { return is_declarationDeclaration() || is_declarationDeclarator()
    ...
    void reset() { SuperName::reset(); SuperMeta::reset(); SuperExpr::reset();
