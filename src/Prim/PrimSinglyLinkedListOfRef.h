...
public:
 ...
 const E& operator[](size_t anIndex) const { const PrimRefValue *p = _list[anIndex];
...
public:
 ...
 const PrimRef<E>& operator[](size_t anIndex) const { const PrimRefValue *p = find_at(functions(), anIndex);
